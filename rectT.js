...
canvas.addEventListener('mousedown', bg())
 function bg(e) {
  mousedown = true;
...
canvas.addEventListener('mouseup', bh())
function bh(e) {
...
canvas.addEventListener('mouseout', bi())
function bi(e) {
...
canvas.addEventListener('mousemove', bj())
function bj(e) {
...
function redraw() {
  ...
  //var context = document.getElementById("paint-canvas").getContext('2d');
...
square.addEventListener("click", function(){ tryrect(), isrect = true })
